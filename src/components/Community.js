                                ...
                                <div className={"row"}>
                                    <div className={"col-lg-6 col-12"}>
                                        ...
                                        <a href="https://www.facebook.com/mijora.lt/" target="_blank">
                                            <img src={FacebookIcon} width="25" className={"mr-2"}/>
                                        </a>
                                        <a href="https://www.instagram.com/mijoralt">
                                            <img src={InstagramIcon} width="25" className={"mr-2"}/>
                                        </a>
                                        <a href="https://www.linkedin.com/company/19261529" target="_blank">
                                            <img src={LinkedInIcon} width="25" className={"mr-2"}/>
                                        </a>
                                        <a href="https://github.com/mijora" target="_blank">
                                            <img src={GithubIcon} width="25" className={"mr-2"}/>
                                        </a>
                                    </div>
                                    <div className={"col-lg-6 col-12 text-right my-auto"}>
                                        <img src={FamilyPhoto} className={"img-fluid pt-lg-0 pt-4"}/>
                                    </div>
                                </div>
                            </div>
                        </div>
